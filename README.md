...
Vamos fazer um checklist objetivo para rodar e testar tudo, incluindo:
...
Você clica em pré-processar

Thread inicia

Prints aparecem no modal

Arquivo processado é salvo em:

data/audio_processed/<grupo>/<arquivo>.wav
