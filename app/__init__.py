...
def create_app():
    ...
    from .blueprints.group_comparison import bp as group_comparison_bp
    from .blueprints.audio_curation import bp as audio_curation_bp
    ...
    app.register_blueprint(audio_curation_bp)
